  ...
  return (
    <div className="px-4">
      ...
      <p>
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Dev
        State; and (d) the link is in the context of general resource information.
      </p>
