      ...
      <Card className=" lg:grid lg:grid-cols-5 p-2 sm:p-4">
        ...
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8 bg-main-0">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <p>
                <span className="text-xs tracking-wide text-neu-9 uppercase">Call us</span>
              ...
              >
                <List.Item>Monday to Friday: 10am - 5pm</List.Item>
                <List.Item>Weekend: 10am - 3pm</List.Item>
              </List>
